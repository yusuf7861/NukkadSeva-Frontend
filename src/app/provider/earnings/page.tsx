    ...
    return (
        <div className="flex bg-slate-50 dark:bg-slate-900 font-sans text-slate-900 dark:text-slate-100 min-h-screen">
            ...
            <main className="flex-1 overflow-y-auto scroll-smooth">
                {/* Top Header */}
                <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 md:px-10 py-3 sticky top-0 z-10">
                    <div className="flex items-center gap-8">
                        <h2 className="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] hidden md:block">Earnings & Payouts</h2>
                        <h2 className="text-slate-900 dark:text-white text-lg font-bold leading-tight tracking-[-0.015em] md:hidden pl-10">Earnings</h2>
                    </div>
                    <div className="flex flex-1 justify-end gap-4 md:gap-8">
                        <div className="flex gap-2">
                            ...
                            <div className="size-10 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden border border-slate-200 dark:border-slate-700 relative">
                                {user?.avatar ? (
                ...
                <div className="p-4 md:p-8 max-w-[1200px] mx-auto">
                    ...
                    <div className="flex flex-col gap-1 mb-6 md:mb-8">
                        <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400 text-sm font-medium">
                            ...
                            <span className="text-slate-900 dark:text-white">Earnings & Payouts</span>
                        </div>
                        <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-4 mt-4">
                            <div>
                                <h1 className="text-slate-900 dark:text-white text-3xl md:text-4xl font-black leading-tight tracking-[-0.033em]">Earnings Overview</h1>
                                <p className="text-slate-500 dark:text-slate-400 text-lg font-normal leading-normal">Track your service revenue and withdraw funds to your account.</p>
                            </div>
