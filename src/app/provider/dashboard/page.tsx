            ...
            <main className="flex-1 overflow-y-auto scroll-smooth">
                ...
                <header className="h-16 border-b border-gray-200 bg-white/80 backdrop-blur-md sticky top-0 z-10 flex items-center justify-between px-8">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-gray-900">{user?.name || user?.username || "Provider"}</span>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="size-9 rounded-full bg-gray-200 overflow-hidden border border-gray-200 relative">
                            {user?.avatar ? (
                ...
                <div className="p-8 max-w-[1200px] mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col gap-2">
                            <div className="flex justify-between items-start">
                                <span className="text-gray-500 text-xs font-semibold uppercase tracking-wider">Jobs Completed</span>
                        ...
                        <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col gap-2">
                            <div className="flex justify-between items-start">
                                <span className="text-gray-500 text-xs font-semibold uppercase tracking-wider">Average Rating</span>
                            ...
                            <p className="text-gray-400 text-xs font-medium">From 112 reviews</p>
                        </div>
                        <div className="bg-white p-6 rounded-xl border border-gray-200 flex flex-col gap-2">
                            <div className="flex justify-between items-start">
                                <span className="text-gray-500 text-xs font-semibold uppercase tracking-wider">Active Requests</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 flex flex-col gap-6">
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row">
                                <div className="md:w-48 h-48 md:h-auto overflow-hidden shrink-0 relative bg-gray-200">
                                    ...
                                    <div className="absolute top-3 left-3 bg-white/90 backdrop-blur rounded px-2 py-1 flex items-center gap-1">
                                        ...
                                        <span className="text-[10px] font-bold text-gray-900">24m ago</span>
                                    </div>
                                </div>
                                <div className="p-6 flex-1 flex flex-col justify-between">
                                    <div>
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[11px] font-bold uppercase">Plumbing</span>
                                        </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button className="px-4 h-10 border border-gray-200 text-gray-600 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors">Decline</button>
                                    </div>
                                </div>
                            </div>
                            {/* Job Card 2 */}
                            <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row">
                                <div className="md:w-48 h-48 md:h-auto overflow-hidden shrink-0 relative bg-gray-200">
                                    ...
                                    <div className="absolute top-3 left-3 bg-white/90 backdrop-blur rounded px-2 py-1 flex items-center gap-1">
                                        <span className="material-symbols-outlined text-xs text-gray-900">schedule</span>
                                        <span className="text-[10px] font-bold text-gray-900">1h ago</span>
                                    </div>
                                </div>
                                <div className="p-6 flex-1 flex flex-col justify-between">
                                    <div>
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-[11px] font-bold uppercase">Electrical</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-gray-500 text-sm mb-3">
                                            <span className="material-symbols-outlined text-[18px]">location_on</span>
