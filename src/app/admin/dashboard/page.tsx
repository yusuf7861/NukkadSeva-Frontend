...
export default function DashboardPage() {
    ...
    const cards = [
        { label: "Total Providers", value: stats.totalProviders, icon: Users, color: "bg-blue-500", light: "bg-blue-50", text: "text-blue-700", href: "/admin/providers" },
        { label: "Pending Approvals", value: stats.pendingProviders, icon: Clock, color: "bg-amber-500", light: "bg-amber-50", text: "text-amber-700", href: "/admin/providers?tab=pending" },
        { label: "Approved", value: stats.approvedProviders, icon: CheckCircle, color: "bg-emerald-500", light: "bg-emerald-50", text: "text-emerald-700", href: "/admin/providers?tab=approved" },
        { label: "Rejected", value: stats.rejectedProviders, icon: XCircle, color: "bg-red-500", light: "bg-red-50", text: "text-red-700", href: "/admin/providers?tab=rejected" },
    ];
        ...
        <div>
            ...
            <div className="mt-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <Link href="/admin/providers?tab=pending" className="flex items-center gap-4 bg-white rounded-xl p-5 border border-gray-100 hover:shadow-md transition-all">
                    ...
                    <Link href="/admin/cities" className="flex items-center gap-4 bg-white rounded-xl p-5 border border-gray-100 hover:shadow-md transition-all">
                    ...
                    <Link href="/admin/providers" className="flex items-center gap-4 bg-white rounded-xl p-5 border border-gray-100 hover:shadow-md transition-all">
