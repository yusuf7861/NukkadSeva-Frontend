...
import { Search, MapPin, User, Menu, X, ChevronDown, LogOut, Calendar, CreditCard, UserCircle } from "lucide-react";
                                        ...
                                        {isProfileOpen && (
                                            ...
                                            >
                                                ...
                                                <Link
                                                    ...
                                                    role="menuitem"
                                                >
                                                    <User className="w-4 h-4 mr-3 text-gray-400 group-hover:text-primary-500" />
                                                    Profile
                                                </Link>
